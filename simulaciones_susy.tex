...
\begin{figure}[!htb]
  ...
  \includegraphics[width=0.35\textwidth,keepaspectratio]{gogo-qqqqphphGG-GMSB.pdf}\hspace{1cm}
  \includegraphics[width=0.35\textwidth,keepaspectratio]{gogo-qqqqZZGG-GMSB.pdf}

  \includegraphics[width=0.35\textwidth,keepaspectratio]{gogo-qqqqhphGG-GMSB.pdf}\hspace{1cm}
  \includegraphics[width=0.35\textwidth,keepaspectratio]{gogo-qqqqphZGG-GMSB.pdf}
...
parámetros de masa \emph{soft} de los \emph{squarks} se fijaron en 2.5 \tev.
...
\begin{figure}[!htb]
  ...
  \caption{Tasas de decaimiento (BR) de los gluinos (izquierda) y
    de los neutralinos NLSP en $\gamma\gravino$, $\gamma Z$ y $\gamma h$ (izquierda)
...
\begin{figure}[!htb]
  ...
  \includegraphics[width=0.43\textwidth]{diagrama_a}\hspace{0.5cm}
  \includegraphics[width=0.43\textwidth]{diagrama_b}

  \vspace{1cm}

  \includegraphics[width=0.43\textwidth]{diagrama_c}\hspace{0.5cm}
  \includegraphics[width=0.43\textwidth]{diagrama_d}
...
%%   \caption{Tasas de decaimiento (BR) de los neutralinos NLSP en $\gamma\gravino$, $\gamma Z$ y $\gamma h$
%%     para los distintos puntos de la \emph{grid} en el plano \mgmn. Para cada punto de señal,
