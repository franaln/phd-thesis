...
En particular en esta Tesis se focalizó el análisis de un estado final que
...
\begin{figure}[!htb]
  ...
  \caption{Grid de señal simulada para. Los cuadrados azules representan los distintos puntos
  de señal generados en el plano {\mtmu}. También puede verse la relación con las masas $m_{\gluino}$ y $m_{\ninoone}$.}
...
\cref{fig:signal_br_gl} se puede ver los distintos BR de los gluinos para todos
...
el neutralino. Se pueden ver que el decaimiento dominante es a través de
charginos, pero a medida que la masa del gluino y el neutralino se acercan,
empieza a resultar mas importante el decaimiento directo al neutralino mas
liviano, mientras que en los puntos mas cercanos a la diagonal, el decaimiento
estará dominado por $\gluino\to g\gravino$ el cual no corresponde al estado
final deseado. Los diagramas de los distintos decaimientos posibles se encuentrán
...
{\ninoone} la multiplicidad de jets será menor y la energía del fotón sera mayor
...
\begin{figure}[!htb]
  ...
  \caption{Diagramas de Feynman para la produccion de gluinos y el subsiguiente
...
partículas supersimétricas, se utiliza
