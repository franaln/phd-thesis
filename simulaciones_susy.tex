...
\begin{figure}[!htb]
  ...
  \includegraphics[width=0.35\textwidth,keepaspectratio]{gogo-qqqqphphGG-GMSB.pdf}\hspace{1.5cm}
  \includegraphics[width=0.35\textwidth,keepaspectratio]{gogo-qqqqZZGG-GMSB.pdf}

  \includegraphics[width=0.35\textwidth,keepaspectratio]{gogo-qqqqhphGG-GMSB.pdf}\hspace{1.5cm}
...
\begin{figure}[!htb]
  ...
  \resizebox{0.495\textwidth}{!}{\input{tikz/susy_GGM_M3_mu_850_150.tex}}
  \resizebox{0.495\textwidth}{!}{\input{tikz/susy_GGM_M3_mu_1450_1050.tex}}
...
Para cada uno de los 160 puntos de señal que constituyen la \emph{grid} se generaron
