...
\tikzset{
  ...
  gluon/.style ={decorate, decoration={coilgluon,amplitude=3pt, segment length=4pt}},
  gluino/.style={decorate, decoration={coilgluon,amplitude=3pt, segment length=4pt}, preaction={draw}},
