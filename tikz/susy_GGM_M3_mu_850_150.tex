\begin{tikzpicture}[scale=0.6]
  ...
  \draw (4.6,13.459860)  node[left]  {\large $\tilde{\ell}_\text{L}$};
  ...
  \draw (9.600000,1.104287)   node[left]  {\large $\tilde{\chi}_2^0$};
  \draw (12.350000,0.32)  node[right] {\large $\tilde{G}$};
  \draw (12.4,1.1)  node[right] {\large $\tilde{\chi}_1^\pm$};
  \draw (9.6,1.97)   node[left]  {\large $\tilde{\chi}_3^0$};
  \draw (9.6,13.116866)  node[left]  {\large $\tilde{\chi}_4^0$};
  \draw (12.4,13.116862) node[right] {\large $\tilde{\chi}_2^\pm$};
  \draw (17.4,14.092202) node[right] {\large $\tilde{t}_2$};
