\begin{tikzpicture}
    ...
    \draw[blue, line width=1] (0,0.1) -- (1.05,0.1);
    \draw[blue,line width=1] plot[domain=1.05:5.5, samples=500] ({\x},{1.5*(1 - exp(-((\x-1)/0.8)))});

    \draw[red, line width=1] (0,5.4) -- (1.05,5.4);
    \draw[red,line width=1] plot[domain=1.05:5.5, samples=500] ({\x},{4.+1.5*(exp(-((\x-1)/0.8)))});
