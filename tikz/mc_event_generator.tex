...
\begin{tikzpicture}
  ...
  \node[blue1] at (-1.75,0) {Interacción};
  \node[blue1] at (-1.75,-0.5) {dura};

  \node[blue1] at (0.5,-2.0) {ISR};
  \node[blue1,rotate=45] at (2.5,2) {Decaimientos};


  \draw[blue1, decorate,decoration={brace,amplitude=4pt}] (4.2,0.23) -- (4.2,-0.55);
  \node[blue1] at (5.6, -0.1) {Hadronización};

  \draw[blue1, decorate,decoration={brace,amplitude=4pt}] (-0.2,-3.2) -- (-0.2,-4);
  \node[blue1] at (1,-3.6) {Remanentes};
