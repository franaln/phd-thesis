...
\subsection{Incerteza debida al pile-up ($\alpha_\mathrm{PRW}$)}
...
\subsection{Incerteza en la identificación, escala de energía y resolución de fotones y leptones}
...
\subsection{Eficiencia de identificación de {\bjets} ($\alpha_\text{BJET}$)}
...
%% tions of 22 (20) parameters spanning to the range of experimental uncertainties gives 44 (40) diﬀerent
%% outcomes of cross sections. The αs uncertainty is deﬁned as one half of the diﬀerence between the two
...
%% the envelop. From deﬁnition, the uncertainty is symmetric in plus and minus sides.
