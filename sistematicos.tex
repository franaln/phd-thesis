...
%% Los valores centrales de la sección eficaz fueron obtenidos siguiendo las recomendaciones
%% PDF4LHC \cite{Botje:2011sn}.
%% Una \fix{envelope} de las predicciones a la sección eficaz se define usando
