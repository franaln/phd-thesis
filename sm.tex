...
%% Varios grupos han utilizado las mediciones de HERA [24] y otros experimentos para
%% extrapolar las PDFs a las energı́as del LHC. Para las predicciones teóricas a NLO
%% de esta tesis se han utilizado las parametrizaciones CTEQ
%% 6.6 [25], MSTW 2008 [26] y NNPDF 2.0 [27].
...
%% las masas de
%% los doce fermiones; las tres constantes de acoplamiento $g$, $g'$ y $\alpha_s$;
%% los dos parámetros que describen el potencial de Higgs $v$ y $m_H$; y los ocho
%% ángulos de mezcla. Además el lagrangiano de QCD puede contener una fase,
%% $\theta_{\text{CP}}$, que experimentalmente se conoce que es $\sim 0$.
...
valor natural de \note{$M_P$}{Pasar de $\Lambda$ a $M_P$}, es llamado <<problema de naturalidad>>.
