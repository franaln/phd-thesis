...
\begin{figure}[!htb]
  ...
  \includegraphics[width=0.49\textwidth]{can_crwl_ph_pt_afterFit}
  \includegraphics[width=0.49\textwidth]{can_crwl_rt4_afterFit} \\

  \includegraphics[width=0.49\textwidth]{can_crtl_ph_pt_afterFit}
  \includegraphics[width=0.49\textwidth]{can_crtl_rt4_afterFit} \\

  \includegraphics[width=0.49\textwidth]{can_crql_ph_pt_afterFit}
...
\begin{figure}[!htb]
  ...
  \includegraphics[width=0.49\textwidth]{can_crwh_ph_pt_afterFit}
  \includegraphics[width=0.49\textwidth]{can_crwh_ht_afterFit} \\

  \includegraphics[width=0.49\textwidth]{can_crth_ph_pt_afterFit}
  \includegraphics[width=0.49\textwidth]{can_crth_ht_afterFit} \\

  \includegraphics[width=0.49\textwidth]{can_crqh_ph_pt_afterFit}
...
\begin{figure}[!htb]
  ...
  \includegraphics[width=0.49\textwidth]{plot_vrm75_l_met_et_after}
  \includegraphics[width=0.49\textwidth]{plot_vrm75_l_rt4_after} \\

  \includegraphics[width=0.49\textwidth]{plot_vrr_l_met_et_after}
  \includegraphics[width=0.49\textwidth]{plot_vrr_l_rt4_after} \\
...
%%   \includegraphics[width=0.49\textwidth]{plot_vrh_l_met_et_after}
%%   \includegraphics[width=0.49\textwidth]{plot_vrh_l_rt4_after} \\

%%   \caption{Distribuciones observadas de {\met} (izquierda) y {\HT} (derecha) para la región de validación VRH asociada a {\SRH}.}
%%   \label{fig:bkgfit_vr}
%% \end{figure}
