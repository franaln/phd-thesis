...
En el caso de {\ttgam}, cada \emph{quark top} decae en un bosón $W$ y un
...
\begin{table}[!htbp]
  ...
  $\nleptons$      &          1 &          1 &  $\ge 1$ &  $\ge 1$  &        1 &          1 &  $\ge 1$ &  $\ge 1$  \\
  {\met} [\gev]              &     $>200$ &  [100-200] &   $>200$ &  [80-200] &   $>300$ &  [100-200] &   $>300$ &  [80-200] \\
  $\njets \ge$      &          4 &          4 &        4 &         4 &        2 &          2 &        2 &         2 \\
  $\nbjets$        &          0 &          0 &  $\ge 1$ &   $\ge 1$ &        0 &          0 &  $\ge 1$ &   $\ge 1$ \\
...
La probabilidad de identificación errónea {\feg} se define entonces como:
...
\item \emph{Trigger} de electrones %% (\texttt{2e12Tvhi\_loose}, \texttt{e24vhi\_medium} o \texttt{e60\_medium}).
...
\begin{itemize}\itemsep0.1cm
\item \emph{Triggers} de electrones %%(\texttt{2e12Tvhi\_loose1} o \texttt{e24vhi\_medium1} o \texttt{e60\_medium1})
...
\begin{figure}[!h]
  ...
  \includegraphics[width=0.45\textwidth]{electron_iso_ZeeHMC_corr}
  \includegraphics[width=0.45\textwidth]{electron_iso_ZeeH_corr}
...
\begin{figure}[!h]
  ...
  \includegraphics[width=0.45\textwidth]{bkg_mc_pseudo_data_SR_l_ptbin}
  \includegraphics[width=0.45\textwidth]{bkg_mc_pseudo_data_SR_lp_ptbin}
...
\begin{figure}[!h]
  ...
  \includegraphics[width=0.45\textwidth]{bkg_data_pseudo_tight_data_VR}
...
\begin{table}[!h]
  ...
  \begin{tabular}{rc}
    ...
    $\njets \ge$                             &             2 \\ %           2 \\
    $\pt^{\mathrm{jet}_1,\mathrm{jet}_2}$  [\gev]  $>$             &           100 \\ %         100 \\
    $\dphijm >$                              &           0.4 \\ %         0.4 \\
    \HT [\gev] $>$                           &           600 \\ %         200 \\
    \hline
  \end{tabular}
...
\begin{figure}[!htbp]
  ...
  \includegraphics[width=0.45\textwidth]{bkg_pseudo_data_SR_VR_l}
  \includegraphics[width=0.45\textwidth]{bkg_pseudo_data_SR_VR_lp}
...
\begin{figure}[!h]
  ...
  \includegraphics[width=0.32\textwidth]{iso_fit_sig}
  \includegraphics[width=0.32\textwidth]{iso_fit_bkg}
  \includegraphics[width=0.32\textwidth]{iso_fit_sarange}
...
\begin{figure}[!h]
  \centering
  \includegraphics[width=0.45\textwidth]{nfakes_srl}  \hspace{1cm}
  \includegraphics[width=0.45\textwidth]{nfakes_srh}
