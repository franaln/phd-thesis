...
El electron \emph{tag} se requiere que pase el criterio de identificacion \texttt{tight++}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.45\textwidth]{figures/figura}
  \includegraphics[width=0.45\textwidth]{figures/figura}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.6\textwidth]{figures/figura}
...
\begin{figure}[h]
  \begin{center}
    \includegraphics[width=0.49\textwidth]{figures/figura} %ph_el_data_raw.eps}
    \includegraphics[width=0.49\textwidth]{figures/figura} %ph_el_correction.eps}
...
\begin{figure}[h]
  \begin{center}
  \includegraphics[width=0.49\textwidth]{figures/figura}  \hfill
  \includegraphics[width=0.49\textwidth]{figures/figura}
