...
%% La luminosidad instantanea se define como el numero de protones que pasan por unidad
...
El espectrómetro de muones es el sub-detector mas grande de ATLAS, construido
...
los eventos son de \hl{baja energía} y no son de interés para los análisis de fisica,
...
permitido para su almacenamiento permanente ($\sim 200$ Hz)\note{400?} \cite{Aad:2012xs}. El tamaño típico
...
Esencialmente, el sistema de \emph{trigger} de ATLAS\hl{[ref]} consiste en una selección
...
producidas en mas de una colisión partícula-partícula llegan al detector al
mismo tiempo, o mas generalmente que sus señales se superponen de una forma que
...
instantánea. El numero de colisiones de partículas real que tienen lugar cuando
...
luminosidad instanea. Al igual que $L$, $\avg{\mu}$ depende del numero de
...
Durante el ano 2012 ATLAS colecto datos de las colisiones $pp$ provistas
...
durante el a\~no 2012. Estos eventos colectados corresponden a una luminosidad
