...
Para distinguir entre candidatos de fotones reales (provenientes de la colisión) de fotones de fondo
...
\textsc{staco}\cite{staco} que combina la información del detector de
...
criterios de identificación detallados pueden verse en \cite{atlas}.
...
lo que se llama momento transverso faltante ($\bm{\met}$) y puede indicar la
...
Finalmente, la energía faltante {\met} y el ángulo azimutal de la misma
