...
cerca posible al valor verdadero.%% , y la estimación de un intervalo es determinar
...
se debe a Neyman \note{Agregar referencia}, o utilizando un método alternativo.
...
Para una observación cercana al numero de eventos esperado de solo-fondo ($\clb
...
En este limite, $f(q_0|0)$ es independiente de los parámetros
