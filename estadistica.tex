...
En el caso de que la función likelihood dependa de muchos parámetros, pero sólo
...
%% $\mu$.
La razón para poner $q_\mu = 0$ para $\hat{\mu} > \mu$ es que cuando se establece
