...
hipótesis alternativa $H_1$ y del poder del constraste que se define como $(1-\beta)$:
...
%% (the profile value of \btheta), el cociente de \emph{likelihood} es,
...
como un parámetro nuisance en la función \emph{likelihood}. Pero como $b$ puede
