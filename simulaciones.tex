...
\begin{table}[ht]
  ...
  %\small
  \footnotesize
  \caption{Generator-level filter efficiency [\%] for simulated GGM signal points.} %The last column shows the efficiency of the generator level filter applied, to be considered for the final signal normalization.}
...
\begin{figure}[ht!] %  figure placement: here, top, bottom, or page
   \centering
   \includegraphics[width=0.32\textwidth]{figures/figura}  %%_n1g_full.eps}
   \includegraphics[width=0.32\textwidth]{figures/figura}  %%_n1qq_full.eps}
   \includegraphics[width=0.32\textwidth]{figures/figura} \\ %%_n1_full.eps} \\
   \includegraphics[width=0.32\textwidth]{figures/figura}  %%_n2g_full.eps}
   \includegraphics[width=0.32\textwidth]{figures/figura}  %%_n2qq_full.eps}
   \includegraphics[width=0.32\textwidth]{figures/figura} \\ %%_n2_full.eps} \\
   \includegraphics[width=0.32\textwidth]{figures/figura}  %%_n3g_full.eps}
   \includegraphics[width=0.32\textwidth]{figures/figura}  %%_n3qq_full.eps}
   \includegraphics[width=0.32\textwidth]{figures/figura} \\ %%_n3_full.eps} \\
   \includegraphics[width=0.32\textwidth]{figures/figura} \\ %%_c1qq_full.eps} \\
...
\begin{figure}[ht!]
  \centering
  \includegraphics[width=0.49\textwidth]{figures/figura} %SigXsec_total}
  \includegraphics[width=0.49\textwidth]{figures/figura} %SigXsec_ewkFrac}
