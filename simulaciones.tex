\chapter{Modelo de señal y generación de eventos}\label{cap:simulaciones}
...
%% \begin{figure}
%%   \centering
%%   \scalebox{0.8}{\input{tikz/mc_event_generator.tex}}
%% \end{figure}
...
Un\note{Arreglar} repesado evento a eventos es aplicado a todas las muestras MC para modelar las condiciones
