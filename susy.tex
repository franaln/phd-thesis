...
sectores del modelo. %% Para esto se deben diagonalizar las matrices de masa y así
%% obtener los auto-estados y los auto-valores de masa del modelo.
...
Esta supresión de la taza de decaimiento también significa que todas las
...
\begin{figure}[h]
  ...
  \caption{Tazas de decaimiento del neutralino mas liviano a gravitino mas fotones o bosones $Z$ en funcion de la masa del mismo. En la izquierda
