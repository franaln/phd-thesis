...
Si incluimos la gravedad, el gravitón de espín 2 (con dos estados de helicidad,
...
spartículas del MSSM.%% si $M_\text{mess} \ll M_P$. E
...
\note{Hasta donde llego aca? El resto va en la parte de se\~nal?}
...
\note{Incompleto}En los colisionadores hadrónicos, las partículas supersimétricas pueden son
